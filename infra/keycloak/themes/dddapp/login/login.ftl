                        ...
                        <div class="panel-body" >
                            ...
                            <form id="kc-form-login" class="${properties.kcFormClass!}" onsubmit="login.disabled = true; return true;" action="${url.loginAction?keep_after('^[^#]*?://.*?[^/]*', 'r')}" method="post">
                                ...
                                <div class="${properties.kcInputWrapperClass!} mb-2">
                                    ...
                                    <input tabindex="2" id="password" class="${properties.kcInputClass!}" name="password" type="password" autocomplete="off" placeholder="Hasło"/>
                                </div>
                                <#if realm.resetPasswordAllowed>
                                  <div class="text-center mb-3"><a class="forgot-password" href="${url.loginResetCredentialsUrl}">Zapomniałeś hasła?</a></div>
                                </#if>
                                ...
                                <div id="kc-form-buttons" class="${properties.kcFormButtonsClass!}">
                                    <div class="${properties.kcFormButtonsWrapperClass!}">
                                        <input tabindex="4" class="${properties.kcButtonClass!}" name="login" id="kc-login" type="submit" value="Zaloguj się"/>
                                ...
                                <#if realm.password && realm.registrationAllowed && !usernameEditDisabled??>
                                    <div class="form-group mt-4">
                                        <div class="col-md-12 control">
                                            <a class="btn btn-primary w-100" tabindex="6" href="${url.registrationUrl}">
                                                Zarejestruj
                                            </a>
                                        </div>
                                    </div>

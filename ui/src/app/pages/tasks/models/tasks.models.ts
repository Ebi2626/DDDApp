...
export const mockTasks: Task[] = [
  {
    ...
    description:
      'Przebiec dystans półmaratonu aby przekonać się, czy mam odpowiednią kondycję fizyczną.',
    completed: false,
    type: 0,
  ...
  },
  {
    ...
    description:
      'Wprowadzić rutynę biegania krótkich dystansów codziennie, by przygotować organizm do wysiłku.',
    completed: false,
    type: 1,
    verification_method: 0,
